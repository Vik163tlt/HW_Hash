...
public class Task_2_2 {
    ...
    public Task_2_2(int firstNumber, int secondNumber) {
        this.number1 = firstNumber;
        this.number2 = secondNumber;
    }

    public static Task_2_2 getTasks(List<Integer> list) {
        Random random = new Random();
        int firstNumber = random.nextInt(list.size())+2;
        int secondNumber = random.nextInt(list.size())+2;
        Task_2_2 task = new Task_2_2(firstNumber, secondNumber);
        return task;
